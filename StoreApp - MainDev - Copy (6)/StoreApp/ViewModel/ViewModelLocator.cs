...
namespace StoreApp.ViewModel
{
    ...
    public class ViewModelLocator
    {
        ...
        public ViewModelLocator()
        {
            ...
            SimpleIoc.Default.Register<MasterPagesViewModel>();//New
            SetupNavigation();//New 
        }
        ...
        public MasterPagesViewModel MasterPagesViewModel => ServiceLocator.Current.GetInstance<MasterPagesViewModel>();
